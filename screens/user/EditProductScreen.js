...
const formReducer = (state, action) => {
  if (action.type === FORM_INPUT_UPDATE) {
    ...
    return {
      ...
      inputValiditites: updatedValidities,
...
console.log('inputV', FORM_INPUT_UPDATE)
...
const EditProductScreen = (props) => {
  ...
  const submitHandler = useCallback(() => {
    if (!formState.formIsValid) {
      Alert.alert("Incorrect input", "Fields can not be blank", [
        { text: "OK" },
      ]);
      return;
    }
      ...
      <View style={styles.form}>
        <View style={styles.editContainer}>
          ...
          <TextInput
            ...
            autoCorrect
            returnKeyType="next"
            onEndEditing={() => console.log('onEndEditing2')}
            onSubmitEditing={() => console.log('onSubmitEditing')}
          />
          {!formState.inputValiditites.title && <Text>Please enter a valid title.</Text>}
        </View>
        <View style={styles.editContainer}>
